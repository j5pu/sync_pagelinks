...
class IgooCoRouter(object):
    ...
    def db_for_read(self, model, **hints):
        ...
        if model._meta.app_label == 'igoo_co':
            return 'igoo_co'
        return None
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        if obj1._meta.app_label == 'igoo_co' or obj2._meta.app_label == 'igoo_co':
            return True
        return None
    ...
    def allow_migrate(self, db, model):
        ...
        return model._meta.app_label != 'igoo_co'